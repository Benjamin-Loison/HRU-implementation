...
type state_r = {
  subj : object_t list;
  obj : object_t list;
  rights : (object_t * object_t, right_t) Hashtbl.t;
}
type condition_t =
    Top
  | Basic_condition of right_t * object_t * object_t
  | And of condition_t * condition_t
  | Or of condition_t * condition_t
  | Neg of condition_t
type operation_t =
    Enter of right_t * object_t * object_t
  | Delete of right_t * object_t * object_t
  | Create_subject of object_t
  | Destroy_subject of object_t
...
val checkRight : state_r -> right_t -> object_t -> object_t -> bool
